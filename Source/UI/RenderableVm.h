...
public:
	...
	RenderableVm(ResourceManager* res, Renderable* target, 
	...
	/*, _models(models)*/
	{
		...
		{
			IMeshResource* model = models->at(renderableMesh.MeshId);
...
private:
	...
	Renderable* _target = nullptr;
	//const std::vector<TextureResource*>* _textures = nullptr;
	//const std::vector<IModel*>* _models = nullptr;
